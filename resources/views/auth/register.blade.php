    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="mt-4">
         ...
         <div class="mt-4">
            ...
            <x-text-input id="phone" class="block mt-1 w-full" type="text" name="phone" :value="old('number')" required autocomplete="phone" />
         ...
         <div class="mt-4">
            ...
            <x-text-input id="number" class="block mt-1 w-full" type="text" name="address" :value="old('address')" required autocomplete="address" />
