<x-app-layout>
    ...
    <div style="text-align: center; margin-bottom: 20px;">
        <a href="{{ route('carbon-credits.create') }}" class="btn btn-primary" style="background-color: #007bff; border: none; padding: 10px 20px; font-size: 16px; color: white; border-radius: 5px; text-decoration: none;">
            Add Carbon Credit
        </a>
    </div>
            ...
            <tbody>
                @foreach ($carbonCredits as $credit)
                    <tr style="border-bottom: 1px solid #6c757d;">
                        ...
                        <td>
                            <a href="{{ route('carbon-credits.edit', $credit) }}" class="btn btn-warning" style="margin-right: 5px; color: white;">
                                Edit
                            </a>
                            <form action="{{ route('carbon-credits.destroy', $credit) }}" method="POST" style="display:inline;">
                                @csrf
                                @method('DELETE')
